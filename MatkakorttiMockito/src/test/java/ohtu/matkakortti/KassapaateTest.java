...
public class KassapaateTest {
    ...
    @Test
    public void lataaMetodiLataaHalutunPositiivisenSumman() {
        int summa = 1;
        kassa.lataa(kortti, summa);
        verify(kortti, times(1)).lataa(eq(summa));
    }

    @Test
    public void lataaMetodiEiLataaNegatiivistaSummaa() {
        int summa = -1;
        kassa.lataa(kortti, summa);
